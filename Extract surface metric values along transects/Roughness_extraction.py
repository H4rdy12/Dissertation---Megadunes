...
#DEM_pathway = './Site A roughness_tif.tif'
DEM_pathway = './REMA 100m roughness.tif'
attempt = '01'
...
#DEM_pathway = './Site B roughness tif.tif'
DEM_pathway = './REMA 100m roughness.tif'
attempt = '01'
...
#DEM_pathway = './Site C roughness tif.tif'
DEM_pathway = './REMA 100m roughness.tif'
attempt = '01'
...
#DEM_pathway = './Site D roughness tif.tif'
DEM_pathway = './REMA 100m roughness.tif'
attempt = '01'
...
#DEM_pathway = './Site E roughness tif.tif'
DEM_pathway = './REMA 100m roughness.tif'
attempt = '01'
...
# Plots    
    ...
    plt.savefig('./Continent and combined roughness extraction hist.jpg',dpi=400, transparent=True)
    plt.savefig('./Continent and combined roughness extraction hist.jpg',dpi=400, transparent=True)
    plt.show()
...
# Stats
    ...
    roughness_df_fin.to_csv('./Roughness_100m_df.csv', index=False)
